...
#  parameters ending in "_Godderis" are only activated if "Godderis" is set to TRUE (third line in the code below); in this case, the corresponding non-Goddéris parameter choices are ignored.
...
#Goddéris Y, Donnadieu Y, Lefebvre V, Le Hir G & Nardin E. 2012. Tectonic control of continental weathering, atmospheric CO2, and climate over Phanerozoic times. Comptes Rendus Geoscience 344: 652-662.
...
#Royer DL, Donnadieu Y, Park J, Kowalczyk J, Goddéris Y. 2014. Error analysis of CO2 and O2 estimates from the long-term geochemical model GEOCARBSULF. American Journal of Science, 314: 1259-1283..

#VAR1 'resampleN' is number of resamples for the Monte Carlo error analysis; if you wish to bypass resampling, set to 1 else normaly 10000
resampleN <- 1  
#VAR2 'Godderis' set to "TRUE" to run time arrays of fA, fAw/fA, fD, and GEOG from Goddéris et al, 2012; set to "FALSE" to run standard time arrays from GEOCARBSULF.
Godderis <- TRUE
